...
public class CreateAccountActivity extends BaseActivity {
    ...
    private Spinner mSpinnerSchoolLevelCreate;
    private String mUserName, mUserEmail, mPassword,mSchoolLevel;
    private String mUserTagline="This is your description";
    ...
    public void initializeScreen() {
        ...
        mSpinnerSchoolLevelCreate=(Spinner) findViewById(R.id.spinner_school_level_create);
        // Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> schoolLevelAdapter = ArrayAdapter.createFromResource(this,
        ...
        mSpinnerSchoolLevelCreate.setAdapter(schoolLevelAdapter);
        //get the selected value
        mSpinnerSchoolLevelCreate.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                mSchoolLevel=mSpinnerSchoolLevelCreate.getSelectedItem().toString();
            }

            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                mSchoolLevel="HIGH SCHOOL";
    ...
    private void createUserInFirebaseHelper(final String authUserId) {
        ...
        User newUser = new User(mUserName, mSchoolLevel, encodedEmail,timestampJoined);
